...
public class EscolhaMoto {
    public void escolhaMoto() {
        ...
        while (motoEscolhidaIndex < escolha) {
            ...
            if (motoEscolhidaIndex == escolha - 1) {
                ...
                boolean viagemRealizada = motoEscolhida.viajar(distanciaViagem);
                if (viagemRealizada) {
                    System.out.println("Viagem realizada com sucesso!");
                    System.out.println("Combustível restante: " + motoEscolhida.getCombustivelNoTanque() + " litros");
                } else {
                    ...
                    if (resposta.equalsIgnoreCase("S")) {
                        ...
                        motoEscolhida.abastecer(litrosAbastecidos);

                        System.out.println("Veículo abastecido com sucesso!");
                        System.out.println("Combustível atual: " + motoEscolhida.getCombustivelNoTanque() + " litros");
                        System.out.println("Safe travel!");
                    } else {
                        System.out.println("você não consegue realizar a viagem");
                    }
                }
                break;
            }
